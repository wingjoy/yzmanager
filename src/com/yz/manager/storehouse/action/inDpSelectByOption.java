...
public class inDpSelectByOption extends ActionSupport  {
	...
	public String execute() throws Exception {
		...
		int total=storeHouseDao.selectMyStoreByOptionInt(collect,this.getInDepartment(),this.getDepartment(),this.getHouseId(),this.getFirstCName(),this.getSecondCName(),
		...
		ep=storeHouseDao.selectMyStoreByOption(collect,this.getInDepartment(),this.getDepartment(),this.getHouseId(),this.getFirstCName(),this.getSecondCName(),
