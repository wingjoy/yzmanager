...
public class myOutStoreByOption extends ActionSupport  {
	...
	public String execute() throws Exception {
		...
		int total=storeHouseDao.selectMyOutStoreByOptionInt(this.getDepartment(),this.getHouseId(),this.getFirstCName(),this.getSecondCName(),
				bg,ed,user.getUserName());
		...
		ep=storeHouseDao.selectMyOutStoreByOption(this.getDepartment(),this.getHouseId(),this.getFirstCName(),this.getSecondCName(),
				bg,ed,user.getUserName(),currentPage,pageSize);
