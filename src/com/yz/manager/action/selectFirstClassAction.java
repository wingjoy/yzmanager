...
public class selectFirstClassAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		if("-1".equals(dp)&"-1".equals(s)){
			total=daoUtil.selectFirstClassSize();
			sfc=daoUtil.selectFirstClass2(currentPage,pageSize);
		}else if("-1".equals(dp)&!"-1".equals(s)){
			total=daoUtil.selectFirstClassSize(s);
			sfc=daoUtil.selectFirstClass3(s,currentPage,pageSize);
		}else if(!"-1".equals(dp)&"-1".equals(s)){	
			total=daoUtil.selectFirstClassSize1(dp);
			sfc=daoUtil.selectFirstClass31(dp,currentPage,pageSize);
		}else if(!"-1".equals(dp)&!"-1".equals(s)){	
			total=daoUtil.selectFirstClassSize(dp,s);
