...
<body  bgcolor="#E4FAF9">
 ...
 <h1 class="h1" align="center">增加用户</h1>
   <%
    ...
    <s:form action="adduserAction" method="post" theme="simple">
       ...
       <table class="left-font01" align="center" border="0" cellspacing="0" cellpadding="0" >
          ...
          <tr>
             <td> 部    门：</td>
             <td align="center"> <s:select style="width:160px;" name="department" list="#request.department"  headerKey="-1" headerValue="选择部门" listKey="key" listValue="value" ></s:select></td>
              <td class="actionmessage"> 
                 <s:fielderror  >   
                         <s:param>nulldepartment</s:param>
                 </s:fielderror>
             </td>
         </tr>
            <tr><td>&nbsp;</td></tr>
