    ...
    <s:form action="selectUserByDAction?currentPage=1" method="post" theme="simple">
      <table class="left-font01" width="30%" align="center" border="0" cellspacing="0" cellpadding="0" >
          <tr>
             ...
             <td align="right"><a class='left-font01' href="/user/adduser.jsp">增加用户</a></td>
         </tr>
       ...
       <table class="left-font01" width="80%"  align="center" border="1" cellspacing="0" cellpadding="0" >
          ...
          <th>用户名</th><th>姓名</th><th>所在部门</th><th>删除</th><th>修改</th>
          </tr>
          <%
            for(user u1 : u){
            ...
            out.println(
              ...
              "<td align='center'>不可删除</td>"
               ...
               out.println(
              "<td align='center'><a class='left-font01' href='"+basepath+"user/deleteUser.action?usId="+u1.getUserId()+"' >删除</a></td>"
              );
              }
              out.println(
              "<td align='center'><a class='left-font01' href='"+basepath+"user/modifyUser.jsp?usId="+u1.getUserId()+"' >修改</a></td>"+
              "</tr>");
            };                   
           %>
        ...
        <table class="tablelink"  align="center">
           <tr align="right">
             ...
             <td><a class="tablelink" href="managerUserByOption.jsp?currentPage=1">首页</a></td>
             <td><a class="tablelink" href="managerUserByOption.jsp?currentPage=<%=pg.searchCurrentPage(currentPage-1) %>">上一页</a></td>
             <td><a class="tablelink" href="managerUserByOption.jsp?currentPage=<%=pg.searchCurrentPage(currentPage+1)%>">下一页</a></td>
             <td><a class="tablelink" href="managerUserByOption.jsp?currentPage=<%=totalPage %>">尾页</a></td>
