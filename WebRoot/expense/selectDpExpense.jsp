...
<body bgcolor="#E4FAF9">
 <%  
  ...
  %>   
    <s:form name="myform" action="selectDpExpenseByOption?currentPage=1" method="post" theme="simple" >
      <table class="left-font01" align="center" border="0" cellspacing="0" cellpadding="0" >
        ...
        %> 
          ...
          <td>
              ...
              <td> &nbsp;<s:submit style="font-size:14px" name="submit" value="查 找"></s:submit>                    
                 &nbsp;<a class="left-font01" href="expenseExportAction.action">费用导出</a></td>   
         </tr>       <tr><td>&nbsp;</td></tr>
        </table>
      </s:form>
       ...
       <table class="left-font01" width="100%"  align="center" border="1" cellspacing="0" cellpadding="0" >
          ...
          <th>序号</th><th>添加日期</th><th>内容</th><th>单价</th><th>数量</th><th>总价</th><th>供应商</th><th>联系人</th><th>联系电话</th><th>供应商地址</th><th>经办人</th><th>费用性质</th><th>备注</th><th>详情</th><th>删除</th><th>修改</th>
          </tr>
          <%
           int i=1;
            for(expense a : ep){
            ...
            out.println(
             ...
             "<td align='center'>&nbsp;"+a.getSupplier()+"</td>"+ 
              ...
              "<td align='center'>&nbsp;"+a.getSupplierAddress()+"</td>"+ 
             "<td align='center'>&nbsp;"+sname+"</td>"+ 
              ...
              "<td align='center'><a class='left-font01' href='deleteDpExpenseAction.action?aId="+a.getId()+"' >>></a></td>"+
         ...
         <table class="tablelink">
           <tr align="right">
             ...
             <td><a class="tablelink" href="selectDpExpense.jsp?currentPage=1">首页</a>&nbsp;</td>
             <td><a class="tablelink" href="selectDpExpense.jsp?currentPage=<%=pg.searchCurrentPage(currentPage-1) %>">上一页</a>&nbsp;</td>
             <td><a class="tablelink" href="selectDpExpense.jsp?currentPage=<%=pg.searchCurrentPage(currentPage+1)%>">下一页</a>&nbsp;</td>
             <td><a class="tablelink" href="selectDpExpense.jsp?currentPage=<%=totalPage %>">尾页</a>&nbsp;</td>
             <td>跳转到第<select name="selectPage" onchange="document.location.href=this.value">           
             <%
                for(int j=1;j<=pg.getTotalpage();j++){
                if(j==currentPage){
                out.println(
                  "<option  selected value='selectDpExpense.jsp?currentPage="+j+"'>&nbsp;&nbsp;"+j+"&nbsp;&nbsp;</option>");
                }else {
                 out.println(
                  "<option value='selectDpExpense.jsp?currentPage="+j+"'>&nbsp;&nbsp;"+j+"&nbsp;&nbsp;</option>");
                }
              }   
              %>           
             </select>页</td>
