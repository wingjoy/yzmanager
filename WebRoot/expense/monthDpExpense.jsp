...
<body bgcolor="#E4FAF9">
 <%  
    int ucount=daoUtil.selectUserCount(user.getDepartment());
    double expenseCount [][]=new double[ucount][12];
    expenseCount=expenseDao.selectMonthExpenseCountByOption(user.getDepartment(),String.valueOf(CurrentDate.getCurrentYear()),"报销","0");
       ...
       <table class="left-font01" width="100%"  align="center" border="1" cellspacing="0" cellpadding="0" >
          ...
          <%    
                ...
                dr.setMaximumFractionDigits(2);
                 ...
                 out.println(
			              "<tr>"+
			              "<td align='center' rowspan='"+m+"'>"+sdp +"<br>（所有公司）</td></tr>");
