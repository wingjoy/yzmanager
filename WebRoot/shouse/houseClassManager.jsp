...
<body bgcolor="#E4FAF9">
 <%
   ...
   int totalsize=0;
     ...
     pg=new PageSet(daoUtil.selectHouseFirstClassSize(),10);  
       ...
       <table class="left-font01" width="80%"  align="center" border="1" cellspacing="0" cellpadding="0" >
          ...
          <%
            ...
            out.println(
              ...
              "<td align='center'><a class='left-font01' href='deleteHouseFirstAction.action?fId="+f.getId()+"' >删除</a</td>"+
               "<td align='center'><a class='left-font01' href='modifyHouseFirstClass.jsp?fId="+f.getId()+"' >修改</a</td>"+
               "<td align='center'><a class='left-font01' href='modifyHouseFSClass.jsp?currentPage=1&fId="+f.getId()+"'>查看</a</td>"+    
              "</tr>");
              }                       
           %>
        ...
        <table class="tablelink"  align="center">
           <tr align="right">
             ...
             <td><a class="tablelink" href="houseClassManager.jsp?currentPage=1">首页</a></td>
             <td><a class="tablelink" href="houseClassManager.jsp?currentPage=<%=pg.searchCurrentPage(currentPage-1) %>">上一页</a></td>
             <td><a class="tablelink" href="houseClassManager.jsp?currentPage=<%=pg.searchCurrentPage(currentPage+1)%>">下一页</a></td>
             <td><a class="tablelink" href="houseClassManager.jsp?currentPage=<%=totalPage %>">尾页</a></td>
             <td>跳转到第<select name="selectPage" onchange="document.location.href=this.value">           
             <%
                for(int j=1;j<=pg.getTotalpage();j++){
                if(j==currentPage){
                out.println(
                  "<option  selected value='houseClassManager.jsp?currentPage="+j+"'>&nbsp;&nbsp;"+j+"&nbsp;&nbsp;</option>");
                }else {
                 out.println(
                  "<option value='houseClassManager.jsp?currentPage="+j+"'>&nbsp;&nbsp;"+j+"&nbsp;&nbsp;</option>");
                }
              }   
              %>           
             </select>页</td>
