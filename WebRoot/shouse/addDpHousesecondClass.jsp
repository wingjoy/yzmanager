...
<%@page import="com.yz.manager.storehouse.bean.*" %> 
 <%
      ...
      fc=daoUtil.selectHouseFirstClass3(user.getDepartment());
    %>
...
<body bgcolor="#E4FAF9">
 ...
 <h1 class="h1" align="center">增加库房物品</h1>
    ...
    <s:form name="myform" action="addDpHouseSecondClassAction" method="post" theme="simple">     
       <table class="left-font01" align="center" border="0" cellspacing="0" cellpadding="0" >
       <s:hidden name="department1" value="%{#session.us.department}" ></s:hidden>    
         <tr>
