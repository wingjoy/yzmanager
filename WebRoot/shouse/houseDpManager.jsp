 ...
 <%
  ...
  %>
       <table class="left-font01"  align="center" border="0" cellspacing="0" cellpadding="0" >
         <tr><td><a class="left-font01" href="addDphouseManager.jsp">增加库房管理员</a></td></tr>
       </table>
       ...
       <table class="left-font01" width="80%"  align="center" border="1" cellspacing="0" cellpadding="0" >
          ...
          <%
            ...
            out.println(
              ...
              "<td align='center'><a class='left-font01' href='deleteDphouseManagerAction.action?mId="+s.getId()+"' >删除</a></td>"+
              "<td align='center'><a class='left-font01' href='modifyDpHouseManager.jsp?Id="+s.getId()+"' >修改</a></td>"+
              "</tr>");
            };                   
           %>
       </table>
