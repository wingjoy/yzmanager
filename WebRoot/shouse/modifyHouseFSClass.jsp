...
<body bgcolor="#E4FAF9"> 
      ...
      <table class="left-font01" width="60%" align="center" border="0" cellspacing="0" cellpadding="0" >
       ...
       <table class="left-font01" width="80%"  align="center" border="1" cellspacing="0" cellpadding="0" >
         ...
         <th>部门</th><th>库房</th><th>一级分类</th><th>二级分类</th><th>单价</th><th>单位</th><th>删除</th><th>修改</th>
          </tr>
          <%
            ...
            out.println(
              ...
              "<td align='center'><a class='left-font01' href='deleteHouseFSAction.action?sId="+f.getId()+"' >删除</a</td>"+
               "<td align='center'><a class='left-font01' href='/shouse/modifyHouseSecondClass.jsp?sId="+f.getId()+"'>修改</a</td>"+            
              "</tr>");
              }                       
           %>
       ...
       <table class="tablelink" width="60%" align="center">
           <tr align="right">
             ...
             <td><a class="tablelink" href="modifyHouseFSClass.jsp?currentPage=1&fId=<%=fid %>">首页</a></td>
             <td><a class="tablelink" href="modifyHouseFSClass.jsp?currentPage=<%=pg.searchCurrentPage(currentPage-1) %>&fId=<%=fid %>">上一页</a></td>
             <td><a class="tablelink" href="modifyHouseFSClass.jsp?currentPage=<%=pg.searchCurrentPage(currentPage+1)%>&fId=<%=fid %>&fId=<%=fid %>">下一页</a></td>
             <td><a class="tablelink" href="modifyHouseFSClass.jsp?currentPage=<%=totalPage %>&fId=<%=fid %>">尾页</a></td>
