...
<body bgcolor="#E4FAF9"> 
 ...
 <h1 class="h1" align="center">增加客户类型</h1>
   <%
    ...
    <s:form action="addCustomTypeAction" method="post" theme="simple">     
       <table class="left-font01" align="center" border="0" cellspacing="0" cellpadding="0" >
         ...
         <tr>    
             <td> 客户名称：</td>
             <td align="center"> <s:textfield style="width:160px;" name="typeName" size="30"></s:textfield></td>
         </tr>
             <tr><td>&nbsp;</td></tr>  
          <tr> 
          <td> &nbsp;</td>
