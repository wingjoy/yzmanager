...
<body bgcolor="#E4FAF9">
 <%  
     ...
     pg=new PageSet(customDao.selectCustomSize(user.getDepartment(),user.getUserName(),true),15);  
     
     totalsize=pg.getTotalsize();
     totalPage=pg.getTotalpage();
     currentPage=Integer.valueOf(request.getParameter("currentPage")).intValue();
    
     cs=customDao.selectCustom(user.getDepartment(),user.getUserName(),true,currentPage,pg.getPagesize());
       ...
       <table class="left-font01" width="100%"  align="center" border="1" cellspacing="0" cellpadding="0" >
          ...
          <%
           int i=1;
            ...
            out.println(
              ...
              "<td align='center'><a class='left-font01' href='deleteCustomRectifyAction.action?aId="+a.getId()+"' >>></a></td>"+
         ...
         <table class="tablelink">
           <tr align="right">
             ...
             <td><a class="tablelink" href="myCustomRectify.jsp?currentPage=1">首页</a>&nbsp;</td>
             <td><a class="tablelink" href="myCustomRectify.jsp?currentPage=<%=pg.searchCurrentPage(currentPage-1) %>">上一页</a>&nbsp;</td>
             <td><a class="tablelink" href="myCustomRectify.jsp?currentPage=<%=pg.searchCurrentPage(currentPage+1)%>">下一页</a>&nbsp;</td>
             <td><a class="tablelink" href="myCustomRectify.jsp?currentPage=<%=totalPage %>">尾页</a>&nbsp;</td>
             <td>跳转到第<select name="selectPage" onchange="document.location.href=this.value">           
             <%
                for(int j=1;j<=pg.getTotalpage();j++){
                if(j==currentPage){
                out.println(
                  "<option  selected value='myCustomRectify.jsp?currentPage="+j+"'>&nbsp;&nbsp;"+j+"&nbsp;&nbsp;</option>");
                }else {
                 out.println(
                  "<option value='myCustomRectify.jsp?currentPage="+j+"'>&nbsp;&nbsp;"+j+"&nbsp;&nbsp;</option>");
                }
              }   
              %>           
             </select>页</td>
