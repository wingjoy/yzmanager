...
<body bgcolor="#E4FAF9">
 <%  
     ...
     pg=new PageSet(customDao.selectCustomSize(false),15);  
     
     totalsize=pg.getTotalsize();
     totalPage=pg.getTotalpage();
     currentPage=Integer.valueOf(request.getParameter("currentPage")).intValue();
    
     cs=customDao.selectCustom(false,currentPage,pg.getPagesize());
  
  %>   
    <s:form name="myform" action="selectDpCustomByOption?currentPage=1" method="post" theme="simple" >
      <table class="left-font01" align="center" border="0" cellspacing="0" cellpadding="0" >
        ...
        <td align="center">&nbsp;&nbsp;添加日期:</td>
           <td>
              ...
              <td>&nbsp;<a class="left-font01" href="customExportAction.action">客户导出</a></td>
         </tr>
       <tr><td>&nbsp;</td></tr>
        </table>
      </s:form>
       ...
       <table class="left-font01" width="100%"  align="center" border="1" cellspacing="0" cellpadding="0" >
          ...
          <%
           int i=1;
            ...
            out.println(
              ...
              "<td align='center'><a class='left-font01' href='deleteDpCustomAction.action?aId="+a.getId()+"' >>></a></td>"+
         ...
         <table class="tablelink">
           <tr align="right">
             ...
             <td><a class="tablelink" href="selectDpCustom.jsp?currentPage=1">首页</a>&nbsp;</td>
             <td><a class="tablelink" href="selectDpCustom.jsp?currentPage=<%=pg.searchCurrentPage(currentPage-1) %>">上一页</a>&nbsp;</td>
             <td><a class="tablelink" href="selectDpCustom.jsp?currentPage=<%=pg.searchCurrentPage(currentPage+1)%>">下一页</a>&nbsp;</td>
             <td><a class="tablelink" href="selectDpCustom.jsp?currentPage=<%=totalPage %>">尾页</a>&nbsp;</td>
             <td>跳转到第<select name="selectPage" onchange="document.location.href=this.value">           
             <%
                for(int j=1;j<=pg.getTotalpage();j++){
                if(j==currentPage){
                out.println(
                  "<option  selected value='selectDpCustom.jsp?currentPage="+j+"'>&nbsp;&nbsp;"+j+"&nbsp;&nbsp;</option>");
                }else {
                 out.println(
                  "<option value='selectDpCustom.jsp?currentPage="+j+"'>&nbsp;&nbsp;"+j+"&nbsp;&nbsp;</option>");
                }
              }   
              %>           
             </select>页</td>
