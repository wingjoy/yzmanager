      ...
      <table class="left-font01" align="center" border="0" cellspacing="0" cellpadding="0" >
       ...
       <table class="left-font01" width="80%"  align="center" border="1" cellspacing="0" cellpadding="0" >
          ...
          <%
            ...
            out.println(
             ...
             out.println(
              "<td align='center'><a class='left-font01' href='/power/addpower.jsp?uname="+u1.getUserName()+"&dp="+u1.getDepartment()+"' >修改</a></td>"+
              "</tr>");
            };     
        %>
       ...
       <table class="tablelink" width="60%" align="center">
           <tr align="right">
             ...
             <td><a class="tablelink" href="managerPowerByOption.jsp?currentPage=1">首页</a></td>
             <td><a class="tablelink" href="managerPowerByOption.jsp?currentPage=<%=pg.searchCurrentPage(currentPage-1) %>">上一页</a></td>
             <td><a class="tablelink" href="managerPowerByOption.jsp?currentPage=<%=pg.searchCurrentPage(currentPage+1)%>">下一页</a></td>
             <td><a class="tablelink" href="managerPowerByOption.jsp?currentPage=<%=totalPage %>">尾页</a></td>
