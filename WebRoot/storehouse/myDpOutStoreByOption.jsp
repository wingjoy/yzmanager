...
<body bgcolor="#E4FAF9">
 <%
  ...
  %>   
    <s:form name="myform" action="myDpOutStoreByOption?currentPage=1" method="post" theme="simple" >
       ...
       <table class="left-font01" width="100%"  align="center" border="1" cellspacing="0" cellpadding="0" >
          ...
          <%
		        out.println(
		             ...
		             "<th>序号</th><th>申请日期</th><th>领用库房</th><th>物品分类</th><th>物品名称</th><th>申请数量</th><th>单位</th><th>部门审核</th><th>库房审核</th><th>库管审核</th><th>详情</th>"+
		             "</tr>"
		            );
		            int k=1;;
        ...
        <table class="tablelink">
           <tr align="right">
             ...
             <td><a class="tablelink" href="myDpOutStoreByOption.jsp?currentPage=1">首页</a>&nbsp;&nbsp;</td>
             <td><a class="tablelink" href="myDpOutStoreByOption.jsp?currentPage=<%=pg.searchCurrentPage(currentPage-1) %>">上一页</a>&nbsp;&nbsp;</td>
             <td><a class="tablelink" href="myDpOutStoreByOption.jsp?currentPage=<%=pg.searchCurrentPage(currentPage+1)%>">下一页</a>&nbsp;&nbsp;</td>
             <td><a class="tablelink" href="myDpOutStoreByOption.jsp?currentPage=<%=totalPage %>">尾页</a>&nbsp;&nbsp;</td>
             <td>跳转到第<select name="selectPage" onchange="document.location.href=this.value">         
             <%
                for(int j=1;j<=pg.getTotalpage();j++){
                 if(j==currentPage){
                   out.println(
                  "<option selected value='myDpOutStoreByOption.jsp?currentPage="+j+"'>&nbsp;&nbsp;"+j+"&nbsp;&nbsp;</option>");
                 }else{
                 out.println(
                  "<option value='myDpOutStoreByOption.jsp?currentPage="+j+"'>&nbsp;&nbsp;"+j+"&nbsp;&nbsp;</option>");
              }
              }   
              %>           
             </select>页</td>
