	 ...
	 <tr>
       ...
       <table class="left-font01" width="100%"  align="center" border="1" cellspacing="0" cellpadding="0" >
          ...
          <%     
                 ...
                 String sname="本部门无库房";
                  int sSize=0; 
                   int m=daoUtil.selectSecondClassSize(String.valueOf(dfc.getId())); 
                    sname=daoUtil.selectShouseName(Integer.valueOf(dfc.getHouseId()).intValue());
                    sSize=daoUtil.selectSecondClassSizeByHouseId(dfc.getHouseId());      
                                 
                    int l=0;
                   for(int k=0;k<dsc.size();k++){         
			          if(dsc.get(k).getFirstCName().equals(String.valueOf(dfc.getId()))){
			             out.println(
				              "<tr  height='25'>");
				              if(k==0){
