...
<body bgcolor="#E4FAF9">
 <%
  ...
  if(user==null) response.sendRedirect("../index.jsp"); 
     ...
     PageSet pg=new PageSet(storeHouseDao.selectVerifyOutStoreSize(user.getUserName()),15);  
     ...
     sh=storeHouseDao.selectVerifyOutStore(user.getUserName(),currentPage,pg.getPagesize());
  %>   
       ...
       <table class="left-font01" width="100%"  align="center" border="1" cellspacing="0" cellpadding="0" >
		        ...
		        out.println(
		            ...
		            for(outStoreHouse e : sh){
		             ...
		             out.println(
		              ...
		              out.println(
		              "<td align='center'><a class='left-font01' href='verifyOutStoreDetail.jsp?aId="+e.getId()+"' >>></a></td>"+                 
		              "</tr>");
		              }   
		         %>
         ...
         <table class="tablelink">
           <tr align="right">
             ...
             <td><a class="tablelink" href="outStoreVerify.jsp?currentPage=<%=pg.searchCurrentPage(currentPage-1) %>">上一页</a>&nbsp;&nbsp;</td>
             <td><a class="tablelink" href="outStoreVerify.jsp?currentPage=<%=pg.searchCurrentPage(currentPage+1)%>">下一页</a>&nbsp;&nbsp;</td>
             <td><a class="tablelink" href="outStoreVerify.jsp?currentPage=<%=totalPage %>">尾页</a>&nbsp;&nbsp;</td>
             <td>跳转到第<select name="selectPage" onchange="document.location.href=this.value">        
             <%
                for(int j=1;j<=pg.getTotalpage();j++){
                 if(j==currentPage){
                      out.println(
                  "<option  selected value='outStoreVerify.jsp?currentPage="+j+"'>&nbsp;&nbsp;"+j+"&nbsp;&nbsp;</option>");
                 }else{
                 out.println(
                  "<option value='outStoreVerify.jsp?currentPage="+j+"'>&nbsp;&nbsp;"+j+"&nbsp;&nbsp;</option>");
                }
              }   
              %>           
             </select>页</td>
