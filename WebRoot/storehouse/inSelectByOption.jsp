       ...
       <table class="table table-bordered" width="100%"  align="center" border="1" cellspacing="0" cellpadding="0" >
		        ...
		        out.println(
		          ...
		          if(sc1!=null&&!sc1.equals("0")&sh.size()!=0){
		                String scname=daoUtil.selectSecondClass8(sh.get(0).getSecondCName());
		                 ...
		                 "<td align='center'>"+k+"</td>");
		                  out.println(
		                 "<td align='center' colspan='7'><span style='color:red'>"+scname+"</span>&nbsp;共入库<span style='color:red'>"+totalsize+"</span>次，第<span style='color:red'>"+currentPage+"</span>页合计数量及费用</td>");
		                  out.println(
        ...
        <table class="tablelink">
           <tr align="right">
             ...
             <td><a class="tablelink" href="<%=basepath %>storehouse/inSelectByOption.jsp?currentPage=1">首页</a>&nbsp;&nbsp;</td>
             <td><a class="tablelink" href="<%=basepath %>storehouse/inSelectByOption.jsp?currentPage=<%=pg.searchCurrentPage(currentPage-1) %>">上一页</a>&nbsp;&nbsp;</td>
             <td><a class="tablelink" href="<%=basepath %>storehouse/inSelectByOption.jsp?currentPage=<%=pg.searchCurrentPage(currentPage+1)%>">下一页</a>&nbsp;&nbsp;</td>
             <td><a class="tablelink" href="<%=basepath %>storehouse/inSelectByOption.jsp?currentPage=<%=totalPage %>">尾页</a>&nbsp;&nbsp;</td>
             <td>跳转到第<select name="selectPage" onchange="document.location.href=this.value">         
             <%
                for(int j=1;j<=pg.getTotalpage();j++){
                 if(j==currentPage){
                   out.println(
                  "<option selected value='"+basepath+"storehouse/inSelectByOption.jsp?currentPage="+j+"'>&nbsp;&nbsp;"+j+"&nbsp;&nbsp;</option>");
                 }else{
                 out.println(
                  "<option value='"+basepath+"storehouse/inSelectByOption.jsp?currentPage="+j+"'>&nbsp;&nbsp;"+j+"&nbsp;&nbsp;</option>");
              }
              }   
              %>           
             </select>页</td>
