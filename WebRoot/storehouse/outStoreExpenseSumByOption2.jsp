...
<body bgcolor="#E4FAF9">
 <%  
    double inStoreCount [][]=(double[][])request.getAttribute("sum");
     ...
     String hId=(String)request.getAttribute("hId");
      ...
      dsc=daoUtil.selectSecondClass61((String)request.getAttribute("dp"),hId,fcm,systemName);
  %>   
    <s:form name="myform" action="outStoreSumByOption" method="post" theme="simple" >
	 ...
	 <tr>
       ...
       <table class="left-font01" width="100%"  align="center" border="1" cellspacing="0" cellpadding="0" >
        ...
        <th align="center">领用部门</th> <th align="center">库房部门</th><th align="center">库房</th><th align="center">物品分类</th><th align="center">物品名称</th><th align="center">1月</th><th align="center">2月</th><th align="center">3月</th><th align="center">4月</th><th align="center">5月</th><th align="center">6月</th><th align="center">7月</th><th align="center">8月</th><th align="center">9月</th><th align="center">10月</th><th align="center">11月</th><th align="center">12月</th><th align="center">领用费用合计</th>
          </tr>
          <%     
                 int p=0; 
                 double ccount=0;
                 ...
                 String sname="本部门无库房";
                  int sSize=0;
                  int s=0;
                   int m=daoUtil.selectSecondClassSize(fcm); 
                    sname=daoUtil.selectShouseName(Integer.valueOf(dfc.getHouseId()).intValue());           
                    int l=0;
                   for(int k=0;k<dsc.size();k++){         
			          if(dsc.get(k).getFirstCName().equals(fcm)){
			             out.println(
				              "<tr  height='25'>");
				              if(k==0){
				              		out.println( "<td align='center' width='7%' rowspan='"+dsc.size()+1 +"'>"+adpname+"<br>"+name+"</td>");
				              		out.println( "<td align='center' width='7%' rowspan='"+dsc.size()+1 +"'>"+sdp+"<br></td>");
				              }
				               if(s==0){
				              		out.println( "<td align='center' width='7%' rowspan='"+dsc.size() +"'>"+sname+"</td>");
				              }
				              if(l==0){
					              out.println(
					              "<td align='center'width='10%' rowspan='"+m+"'>"+dfc.getFirstCName()+"</td>");
			                      l++;
			                   }
			                   out.println(
			                ...
			                for(int i=0; i<12;i++){
		                          ...
		                          s++;
		                  		  p++; 
		                  		  allcount=ccount+allcount;
		                           out.println(	           
					              "<td align='center' style='color:red'>&nbsp;"+dr.format(ccount)+"</td>");    
					              ccount=0;
					   }         
					              out.println("</tr>");     
			     ...
			     out.println(	    
			           "<tr  height='25'><td align='center' colspan='15'>总费用合计</td>"+                
					   "<td align='center' style='color:red'>&nbsp;"+dr.format(allcount)+"</td></tr>");    
           %>
