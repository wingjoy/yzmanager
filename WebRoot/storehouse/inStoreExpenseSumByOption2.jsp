    ...
    <s:form name="myform" action="inStoreSumByOption" method="post" theme="simple" >
	 ...
	 <tr>
       ...
       <table class="left-font01" width="100%"  align="center" border="1" cellspacing="0" cellpadding="0" >
          ...
          <th align="center">入库部门</th><th align="center">库房</th><th align="center">物品分类</th><th align="center">物品名称</th><th align="center">1月</th><th align="center">2月</th><th align="center">3月</th><th align="center">4月</th><th align="center">5月</th><th align="center">6月</th><th align="center">7月</th><th align="center">8月</th><th align="center">9月</th><th align="center">10月</th><th align="center">11月</th><th align="center">12月</th><th align="center">入库费用合计</th>
          </tr>
          <%     
                 int p=0; 
                 double ccount=0;
                   ...
                   for(int k=0;k<dsc.size();k++){         
			          if(dsc.get(k).getFirstCName().equals(fcm)){
			             out.println(
				              "<tr  height='25'>");
				              if(k==0){
				              		out.println( "<td align='center' width='7%' rowspan='"+dsc.size()+1 +"'>"+sdp+"<br>"+name+"</td>");
				              }
				               if(s==0){
