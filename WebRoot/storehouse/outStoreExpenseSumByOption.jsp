 ...
 <%  
    double inStoreCount [][]=(double[][])request.getAttribute("sum");
     ...
     String sdp=daoUtil.selectDepartment3(Integer.valueOf((String)request.getAttribute("dp")).intValue());
      ...
      dfc=daoUtil.selectFirstClass3(collect,(String)request.getAttribute("dp"),systemName);
       String name="";
      ...
      dsc=daoUtil.selectSecondClass6(collect,(String)request.getAttribute("dp"),systemName);
  %>   
			          ...
			          if(dsc.get(k).getFirstCName().equals(String.valueOf(dfc.get(j).getId()))){
			             out.println(
				              ...
				              if(k==0){
				              		...
				              		out.println( "<td align='center' width='7%' rowspan='"+dsc.size()+1 +"'>"+sdp+"</td>");
				              }
				               if(s==0){
