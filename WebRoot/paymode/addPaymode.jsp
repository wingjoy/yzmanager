...
<body bgcolor="#E4FAF9"> 
 ...
 <h1 class="h1" align="center">增加付款方式</h1>
   <%
    ...
    <s:form action="addPayModeAction" method="post" theme="simple">     
       <table class="left-font01" align="center" border="0" cellspacing="0" cellpadding="0" >
         ...
         <tr>    
             <td> 付款方式：</td>
             <td align="center"> <s:textfield style="width:160px;" name="modeName" size="30"></s:textfield></td>
         </tr>
             <tr><td>&nbsp;</td></tr>  
          <tr> 
          <td> &nbsp;</td>
