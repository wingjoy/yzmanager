	...
	<body bgcolor="#E4FAF9">
		...
		<s:form action="verifyArchivesAction" method="post" theme="simple">
			<table class="actionmessage" align="center">
				...
				<tr>
					<td>
						<a class='left-font01' href='javascript:history.go(-1);'>返回</a>
					</td>
				</tr>
			</table>
			<table class="left-font01" width="80%" align="center" border="1"
				...
				<tr height="25">
					...
					<td>
						...
						<span class="xiugai"><span class="xiugai">*可修改</span>
						</span>
					</td>
					<td align="center">
						保存年限
				...
				<tr height="25">
					...
					<%
						if (ar.getFileDir() == null) {
								out.println("<td colspan='3'>无电子档文件</td>");
							} else {
								out.println("<td colspan='3'><a class='left-font01' href='"
										+ ar.getFileDir() + "' >下载查阅</a></td>");
							}
					%>
				</tr>
				<tr height="25">
				...
				<tr height="25">
					...
					<td>
						<s:textarea name="saveArRemarks" value="同意" cols="30" rows="4"></s:textarea>
					</td>
				</tr>
				<tr height="25">
					<td align="right">
					...
					<td colspan="4" align="center">
						<s:submit name="submit" value="审核确认"></s:submit>
						<s:reset name="reset" value="重新填写"></s:reset>
						<br>
					</td>
				</tr>
			</table>
