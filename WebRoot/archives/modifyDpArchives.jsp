...
<body bgcolor="#E4FAF9">
 <%
  ...
  %>
     <s:form action="modifyDpArchivesAction" method="post" theme="simple">
       ...
       <tr>
        ...
        <tr><td><a class="left-font01" href="selectDpArchives.jsp?currentPage=1">返回</a></td></tr>
       </table>
       <table class="left-font01" width="80%"  align="center" border="1" cellspacing="0" cellpadding="0" >
               <s:hidden name="id" value="%{#request.ar.id}" ></s:hidden>
          <tr height="25">
              <td align="center">文件名称</td><td><s:textfield name="fileName" value="%{#request.ar.fileName}" ></s:textfield><span class="xiugai">*可修改</span></td><td align="center">分类</td><td><%= fc%>--<%= sc%></td>
          </tr>
            <tr height="25">
           ...
           <%
            ...
            <tr height="25">
              <td align="center">档案备注</td><td><s:textarea value="%{#request.ar.remarks}" cols="30" rows="4" ></s:textarea><span class="xiugai">*可修改</span></td>
          </tr>
          <tr height="25">
              <td align="center"> 审核意见</td><td><s:textarea value="%{#request.ar.saveArRemarks}" cols="30" rows="4" readonly="true"></s:textarea></td>
          </tr>
           <tr height="25">
            <td align="right">
