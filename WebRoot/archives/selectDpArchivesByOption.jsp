...
<%
   ...
   fc=daoUtil.selectFirstClassId(user.getDepartment(),systemName);
    ...
    us=daoUtil.selectUser();
     ...
     us2=daoUtil.selectDoubleUserId(user.getDepartment());	
...
<body bgcolor="#E4FAF9">
 <%
  ...
  %>   
     <s:form name="myform" action="selectDpArchivesByOption?currentPage=1" method="post" theme="simple" >
        ...
        %>    
          ...
          <td  align="center">  &nbsp;&nbsp;&nbsp;存档日期:</td>
           <td>
             ...
             <td> &nbsp;&nbsp;&nbsp;<a class="left-font01" href="archiveExportByOptionAction.action">档案导出</a></td>                          
         </tr>
       <tr><td>&nbsp;</td></tr>
        </table>
      </s:form>
       ...
       <table class="left-font01" width="100%"  align="center" border="1" cellspacing="0" cellpadding="0" >
          ...
          <%
           int i=1;
            ...
            out.println(
              ...
              "<td align='center'><a class='left-font01' href='deleteDpArchivesAction.action?aId="+a.getId()+"' >>></a></td>"+
               "<td align='center'><a class='left-font01' href='modifyDpArchives.jsp?aId="+a.getId()+"' >>></a></td>"+             
              "</tr>");
              }                       
           %>
         ...
         <table class="tablelink">
           <tr align="right">
             ...
             <td><a class="tablelink" href="selectDpArchivesByOption.jsp?currentPage=1">首页</a>&nbsp;&nbsp;</td>
             <td><a class="tablelink" href="selectDpArchivesByOption.jsp?currentPage=<%=pg.searchCurrentPage(currentPage-1) %>">上一页</a>&nbsp;&nbsp;</td>
             <td><a class="tablelink" href="selectDpArchivesByOption.jsp?currentPage=<%=pg.searchCurrentPage(currentPage+1)%>">下一页</a>&nbsp;&nbsp;</td>
             <td><a class="tablelink" href="selectDpArchivesByOption.jsp?currentPage=<%=totalPage %>">尾页</a>&nbsp;&nbsp;</td>
             <td>跳转到第<select name="selectPage" onchange="document.location.href=this.value">           
             <%
                for(int j=1;j<=pg.getTotalpage();j++){
                if(j==currentPage){
                out.println(
                  "<option  selected value='selectDpArchivesByOption.jsp?currentPage="+j+"'>&nbsp;&nbsp;"+j+"&nbsp;&nbsp;</option>");
                }else {
                 out.println(
                  "<option value='selectDpArchivesByOption.jsp?currentPage="+j+"'>&nbsp;&nbsp;"+j+"&nbsp;&nbsp;</option>");
                }
              }   
              %>           
             </select>页</td>
