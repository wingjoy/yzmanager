...
<body bgcolor="#E4FAF9">
  <%  
     ...
     pg=new PageSet(personalDao.selectPersonalSize(user.getDepartment(),user.getUserName()),15);  
     
     totalsize=pg.getTotalsize();
     totalPage=pg.getTotalpage();
     currentPage=Integer.valueOf(request.getParameter("currentPage")).intValue();
    
     ps=personalDao.selectPersonal(user.getDepartment(),user.getUserName(),currentPage,pg.getPagesize());
       ...
       <table class="left-font01" width="100%"  align="center" border="1" cellspacing="0" cellpadding="0" >
          ...
          <%
           int i=1;
            ...
            out.println(
              ...
              "<td align='center'>&nbsp"+dp+"</td>" +             
              "<td align='center'>&nbsp"+sname+"</td>" + 
         ...
         <table class="tablelink">
           <tr align="right">
             ...
             <td><a class="tablelink" href="selectMyPersonal.jsp?currentPage=1">首页</a>&nbsp;</td>
             <td><a class="tablelink" href="selectMyPersonal.jsp?currentPage=<%=pg.searchCurrentPage(currentPage-1) %>">上一页</a>&nbsp;</td>
             <td><a class="tablelink" href="selectMyPersonal.jsp?currentPage=<%=pg.searchCurrentPage(currentPage+1)%>">下一页</a>&nbsp;</td>
             <td><a class="tablelink" href="selectMyPersonal.jsp?currentPage=<%=totalPage %>">尾页</a>&nbsp;</td>
             <td>跳转到第<select name="selectPage" onchange="document.location.href=this.value">           
             <%
                for(int j=1;j<=pg.getTotalpage();j++){
                if(j==currentPage){
                out.println(
                  "<option  selected value='seleMyctPersonal.jsp?currentPage="+j+"'>&nbsp;&nbsp;"+j+"&nbsp;&nbsp;</option>");
                }else {
                 out.println(
                  "<option value='selectMyPersonal.jsp?currentPage="+j+"'>&nbsp;&nbsp;"+j+"&nbsp;&nbsp;</option>");
                }
              }   
              %>           
             </select>页</td>
