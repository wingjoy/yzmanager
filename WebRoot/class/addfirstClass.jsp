...
<body bgcolor="#E4FAF9"> 
 ...
 <h1 class="h1" align="center">增加一级分类</h1>
   <%
    ...
    <s:form action="addfirstClassAction" method="post" theme="simple">     
       <table class="left-font01" align="center" border="0" cellspacing="0" cellpadding="0" >
           
            <tr>
             <td> 部  门：</td>
             <td align="center"> <s:select style="width:160px;" name="department1" list="#request.department"   listKey="key" listValue="value" ></s:select></td>
         </tr>  
         <tr><td>&nbsp;</td></tr>             
          <tr>
             <td> 系   统：</td>
         ...
         <tr>    
             <td> 一级分类：</td>
             <td align="center"> <s:textfield style="width:156px;" name="firstCName" size="30"></s:textfield></td>
         </tr>
         <tr><td>&nbsp;</td></tr>    
          <tr>
            <td align="right">
