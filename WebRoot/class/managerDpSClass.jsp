       ...
       <table class="left-font01" width="80%"  align="center" border="1" cellspacing="0" cellpadding="0" >
        ...
        <table class="tablelink" width="60%" align="center">
           <tr align="right">
             ...
             <td><a class="tablelink" href="managerDpSClass.jsp?currentPage=1">首页</a></td>
             <td><a class="tablelink" href="managerDpSClass.jsp?currentPage=<%=pg.searchCurrentPage(currentPage-1) %>">上一页</a></td>
             <td><a class="tablelink" href="managerDpSClass.jsp?currentPage=<%=pg.searchCurrentPage(currentPage+1)%>">下一页</a></td>
             <td><a class="tablelink" href="managerDpSClass.jsp?currentPage=<%=totalPage %>">尾页</a></td>
